...
public class AESKeyGen {
    ...
    public static char Rcon[] = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1B, 0x36};

    public static void printMatrix(char[] matrix) {
        for (int i = 0; i < 16; ++i) {
            System.out.print("" + String.format("%02X", (int) matrix[i]) + " ");
            if ((i + 1) % 4 == 0) {
                System.out.println();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < 32; i += 2) {
            cipher[i / 2] = (char) Integer.parseInt("" + t[i] + t[i + 1], 16);
        }
        ...
        for (int i = 0; i < 44; ++i) {
            ...
            for (int j = 0; j < 4; j++) {
                System.out.print("" + String.format("%02X", (int) w[i][j]) + " ");
            }
            System.out.println();
        }
    }
